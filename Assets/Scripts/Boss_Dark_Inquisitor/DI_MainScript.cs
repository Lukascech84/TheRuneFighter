...
public class DI_MainScript : MonoBehaviour
{
    ...
    {
        int maxAttempts = 10; // Kolikr�t se pokus�me naj�t validn� pozici
        for (int attempt = 0; attempt < maxAttempts; attempt++)
        {
            ...
            // Zkontroluj, zda je pozice validn� na NavMeshu
            ...
            {
                return hit.position; // Vr�t� validn� pozici na NavMeshu
            }
        }

        Debug.LogWarning("Nenalezl jsem validn� pozici pro spawnov�n�.");
        return Vector3.zero; // Vr�t� nulu, pokud ��dn� pozice nen� validn�
    }
